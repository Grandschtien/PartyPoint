...
class CalendarPickerHeaderView: UIView {
    ...
    private let arrowImageView = UIImageView(image: Images.calendar_chevron())
    ...
    private func dayOfWeekLetter(for dayNumber: Int) -> String {
        switch dayNumber {
        case 1:
            return Localizable.sunday_letter()
        case 2:
            return Localizable.monday_letter()
        case 3:
            return Localizable.tuesday_letter()
        case 4:
            return Localizable.wednesday_letter()
        case 5:
            return Localizable.thoursday_letter()
        case 6:
            return Localizable.friday_letter()
        case 7:
            return Localizable.saturday_letter()
        default:
            return ""
        }
    }
