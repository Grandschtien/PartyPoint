...
final class CalendarPickerFooterView: UIView {
    ...
    override func layoutSubviews() {
        ...
        previousMonthButton.titleLabel?.font = Fonts.sfProDisplayMedium(size: BUTTON_LABEL_FONT_SIZE)
        nextMonthButton.titleLabel?.font = Fonts.sfProDisplayMedium(size: BUTTON_LABEL_FONT_SIZE)
    }
...
private extension CalendarPickerFooterView {
    ...
    func setupNextButton() {
        ...
        if let chevronImage = UIImage(systemName: "chevron.right.circle.fill") {
            ...
            let attributedString = NSMutableAttributedString(string: "\(Localizable.next()) ")
            ...
            nextMonthButton.setTitle(Localizable.next(), for: .normal)
        }
    ...
    func setupBackButton() {
        ...
        if let chevronImage = UIImage(systemName: "chevron.left.circle.fill") {
            ...
            attributedString.append(
                NSAttributedString(string: " \(Localizable.back())")
            )
            
            previousMonthButton.setAttributedTitle(attributedString, for: .normal)
        } else {
            previousMonthButton.setTitle(Localizable.back(), for: .normal)
        }
        
        previousMonthButton.titleLabel?.textColor = Colors.miniColor()
