...
private extension ProfileInfoStackView {
    ...
    func setupEmailLabel() {
        emailLabel.textColor = Colors.miniColor()
        emailLabel.font = Fonts.sfProDisplayRegular(size: EMAIL_FONT_SIZE)
    }
    
    func setupNameLabel() {
        nameLabel.textColor = Colors.miniColor()
        nameLabel.font = Fonts.sfProDisplaySemibold(size: NAMEL_FONT_SIZE)
    }
}
