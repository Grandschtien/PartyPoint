...
final class CalendarDateCollectionViewCell: UICollectionViewCell {
    private lazy var selectionBackgroundView: UIView = {
        ...
        view.backgroundColor = PartyPointResourcesAsset.buttonColor.color
        return view
    }()
...
private extension CalendarDateCollectionViewCell {
    ...
    func applySelectedStyle() {
        ...
        numberLabel.textColor = isSmallScreenSize ? PartyPointResourcesAsset.buttonColor.color : .white
    ...
    func applyDefaultStyle(isWithinDisplayedMonth: Bool) {
        ...
        numberLabel.textColor = isWithinDisplayedMonth ? PartyPointResourcesAsset.miniColor.color : .secondaryLabel
