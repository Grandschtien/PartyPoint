    ...
    public enum Icon: Equatable {
        ...
        func iconImage() -> UIImage? {
            ...
            case .custom(let image, _):
                return image
            case .done:
                return PartyPointResourcesAsset.icDoneBanner.image
            case .warning:
                return PartyPointResourcesAsset.icWarningBanner.image
            case .info:
                return PartyPointResourcesAsset.icInfoBanner.image
            case .error:
                return PartyPointResourcesAsset.icErrorBanner.image
            default:
                return nil
            }
        }
