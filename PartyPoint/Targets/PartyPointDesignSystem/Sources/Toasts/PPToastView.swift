...
final public class PPToastView: UIView {
    ...
    private func textContainer(data: PPToastData) -> UIView {
        ...
        if let title = data.title, !title.isEmpty {
            ...
            titleLabel.font = PartyPointResourcesFontFamily.SFProDisplay.bold.font(size: fontSize)
            titleLabel.textColor = PartyPointResourcesAsset.mainColor.color
        ...
        let fontSize: CGFloat = data.type == .toast ? 14 : 17
        messageLabel.font = PartyPointResourcesFontFamily.SFProDisplay.regular.font(size: fontSize)
        messageLabel.textColor = PartyPointResourcesAsset.mainColor.color
    ...
    private func buttonSeparator() -> UIView {
        ...
        separator.backgroundColor = PartyPointResourcesAsset.mainColor.color
