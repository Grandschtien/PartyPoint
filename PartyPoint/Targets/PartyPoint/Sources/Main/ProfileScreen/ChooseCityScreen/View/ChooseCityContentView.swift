...
private extension ChooseCityContentView {
    ...
    func setupCloseButton() {
        closeButton.backgroundColor = PartyPointResourcesAsset.miniColor.color.withAlphaComponent(0.7)
        ...
        closeButton.setImage(PartyPointResourcesAsset.closeButton.image, for: .normal)
    }
    
    func setupTableView() {
        tableView.backgroundColor = PartyPointResourcesAsset.mainColor.color
    ...
    func setupTitleLabel() {
        ...
        titleLabel.text = PartyPointResourcesStrings.Localizable.selectCity
    }
    
    func setupConfirmButton() {
        confirmButton.setTitle(PartyPointResourcesStrings.Localizable.done, for: .normal)
...
extension ChooseCityContentView {
    ...
    func setConfirmChoseAction(_ action: @escaping (() -> Void)) {
