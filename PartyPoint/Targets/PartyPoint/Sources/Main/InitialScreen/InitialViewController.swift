...
final class InitialViewController: UIViewController {
    ...
    private lazy var bottomView: UIView = {
        ...
        view.backgroundColor = PartyPointResourcesAsset.mainColor.color
        return view
    }()
    ...
    private lazy var initLabel: UILabel = {
        ...
        label.font = PartyPointResourcesFontFamily.SFProDisplay.semibold.font(size: 25)
        label.text = PartyPointResourcesStrings.Localizable.initLabel
    ...
    private lazy var goButton: PPButton = {
        ...
        button.setTitle(PartyPointResourcesStrings.Localizable.goButtonTitle, for: .normal)
    ...
    private lazy var userOfferLabel: UILabel = {
        let label = UILabel(frame: .zero)
        label.font = PartyPointResourcesFontFamily.SFProDisplay.semibold.font(size: 12)
        label.text = PartyPointResourcesStrings.Localizable.userOffer
    ...
    func setupUI() {
        ...
        view.layer.contents = PartyPointResourcesAsset.concert.image.cgImage
