...
final class MoreEventsAdapter: NSObject {
    ...
    weak var scrollDelegate: PPScrollDelegate?
...
private extension MoreEventsAdapter {
...
extension MoreEventsAdapter: UICollectionViewDelegate {
    func collectionView(
