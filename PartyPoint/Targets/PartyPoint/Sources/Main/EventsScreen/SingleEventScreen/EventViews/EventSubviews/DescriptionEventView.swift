...
final class DescriptionEventView: DefaultEventView {
    ...
    override var titleText: String {
        return PartyPointResourcesStrings.Localizable.description
    }
    ...
    override func setupUI() {
        ...
        descriptionLabel.font = PartyPointResourcesFontFamily.SFProDisplay.semibold.font(size: DESCRIPTION_FONT_SIZE)
    }
