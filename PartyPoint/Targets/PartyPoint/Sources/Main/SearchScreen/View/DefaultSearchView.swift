...
private extension DefaultSearchView {
    ...
    func setupSearchIcon() {
        ...
        searchIcon.backgroundColor = PartyPointResourcesAsset.mainColor.color
        searchIcon.loopMode = .loop
    }
    
    func setupTitleLabel() {
        titleLabel.font = PartyPointResourcesFontFamily.SFProDisplay.bold.font(size: TITLE_LABEL_FONT_SIZE)
        titleLabel.textAlignment = .center
        titleLabel.numberOfLines = numberOfRowsInTitle
    }
    
    func setupSubtitle() {
        subtitleLabel.font = PartyPointResourcesFontFamily.SFProDisplay.regular.font(size: SUBTITLE_LABEL_FONT_SIZE)
