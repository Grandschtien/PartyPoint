...
final class AcceptPasswordViewController: UIViewController {
    ...
    override func loadView() {
        view = contentView
        contentView.configure(with: PartyPointResourcesStrings.Localizable.enterCode,
                              btnTitle: PartyPointResourcesStrings.Localizable.confirm,
                              textFieldPlaceholder: PartyPointResourcesStrings.Localizable.code)
    }
